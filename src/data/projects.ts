...
export const projects: Project[] = [
  {
    ...
    tagline: 'Fogászati weboldal bizalomépítésre, szolgáltatásbemutatásra és időpontfoglalásra optimalizálva.',
  ...
  },
  {
    ...
    posterSrc: '/portfolio/beauty-salon-preview-poster.jpg',
    caseStudy: {
  ...
  },
  {
    ...
    industry: 'hotel',
    industryLabel: 'Hotel',
    tagline: 'Hotel weboldal közvetlen foglalási fókuszú felépítéssel, hogy kevesebb érdeklődő vesszen el.',
    ...
    accentColor: '#5a9aba',
    status: 'concept',
    liveUrl: 'https://hotel-aranyudvar.netlify.app',
  ...
  },
  {
    ...
    tagline: 'Éttermi weboldal erős első benyomással, étlap- és asztalfoglalási fókuszú útvonallal.',
